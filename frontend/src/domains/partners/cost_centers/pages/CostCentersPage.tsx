...
import { Table, Tag, Button, Space, Modal, Form, Input, Switch } from 'antd';
...
const CostCentersPage: React.FC = () => {
  // 🆕 V2 React Query hooks - is_active olmadan tümünü getir
  const { data, isLoading: loading, refetch } = useCostCentersList({ is_active: undefined });
