...
import { useActiveCostCenters } from '@/domains/partners/cost_centers/hooks/useCostCenters';
    ...
    <div style={{ padding: '24px' }}>
      <Card title="Raporlar" extra={
        ...
        <Tabs
          items={[
            {
              key: 'cari-donem-finas',
              label: (
                <span>
                  <BarChartOutlined /> Cari Dönem Finas Raporu
                </span>
              ),
              children: (
                <div>
                  <Space style={{ marginBottom: 16 }}>
                    ...
                    <Button
                      type="primary"
                      onClick={async () => {
                        message.info('Cari Dönem Finas Raporu hazırlanacak');
                      }}
                      loading={loading}
                  ...
                  <Card>
                    <p>
                      <strong>Cari Dönem Finas Raporu</strong> seçilen tarih aralığı ve maliyet merkezi için hazırlanacaktır.
                    </p>
                  </Card>
                </div>
              ),
