...
class LucaBordro(Base):
    ...
    # Özel kesintiler
    ozel_kesinti = Column(Numeric(18, 2), default=0)  # Toplam özel kesinti
    ...
    personnel_id = Column(Integer, nullable=True, index=True)
    monthly_personnel_records_id = Column(Integer, nullable=True, index=True)
