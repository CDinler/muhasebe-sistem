...
class CariReportItem(BaseModel):
    ...
    has_collateral: bool = False  # Bu fişte 326 hesabı var mı (nakit teminat)
...
class CariReport(BaseModel):
    ...
    # Hangi hesap tiplerinin var olduğunu belirt
    has_120_account: bool = False
    has_320_account: bool = False
    has_326_account: bool = False
