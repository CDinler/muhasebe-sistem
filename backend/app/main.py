...
from app.routes.document_types import router as doc_types_router, subtype_router as doc_subtypes_router
...
app.include_router(doc_types_router, prefix="/api/v1", tags=["Document Types"])
app.include_router(doc_subtypes_router, prefix="/api/v1", tags=["Document Subtypes"])
