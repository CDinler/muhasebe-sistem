...
class PayrollCalculation(Base):
    ...
    maas2_normal_calısma = Column(Numeric(18, 2), default=0)
    maas2_hafta_tatili = Column(Numeric(18, 2), default=0)
    maas2_fazla_mesai = Column(Numeric(18, 2), default=0)
    maas2_tatil_mesaisi = Column(Numeric(18, 2), default=0)
    maas2_ucretli_izin = Column(Numeric(18, 2), default=0)
    maas2_toplam = Column(Numeric(18, 2), default=0)  # Yukarıdakilerin toplamı
    
    # Puantaj detayları (gün/saat)
    ...
    # --- ELDEN ÖDEME ---
    elden_ucret_hesaplanan = Column(Numeric(18, 2), default=0)  # Yuvarlama öncesi
    elden_ucret_yuvarlanmis = Column(Numeric(18, 2), default=0)  # 100'e yuvarlanmış
    elden_yuvarlama = Column(Numeric(18, 2), default=0)         # Fark (borç/alacak)
    elden_yuvarlama_yon = Column(String(10), nullable=True)     # BORC / ALACAK
